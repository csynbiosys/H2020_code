...
#define	IPTG      Ith(y,0)
#define	mrna_LacI Ith(y,1)
#define	mrna_TetR Ith(y,2)
#define	LacI      Ith(y,3)
#define	TetR      Ith(y,4)
...
#define	dmrna_LacI Ith(ydot,1)
#define	dmrna_TetR Ith(ydot,2)
#define	dLacI      Ith(ydot,3)
#define	dTetR      Ith(ydot,4)
...
int amigoRHS(realtype t, N_Vector y, N_Vector ydot, void *data){
	...
	dIPTG=K_in_IPTG*(IPTGext-IPTG);
	dmrna_LacI=(k_m0L+k_mL/(1+pow(TetR/theta_TetR*1/(1+pow(aTcext/theta_aTc,N_aTc)),N_TetR))-g_mL*mrna_LacI);
