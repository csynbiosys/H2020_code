function [out] = TSM_fit_to_pulse_input(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    numPulses = 30;     % Number of low-high cycles, corresponds to half of the number of steps
    inducer = log([(1e-5+(1-(1e-5))).*rand(1,1); (1e-5+(100-(1e-5))).*rand(1,1)]) ;  % Extract 2 random input values from the Uniform distribution in (0,1)mM for IPTG and (0,100) ng/mL for aTc, to be used as low and high values in each cycle
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    newExps.u{1}=repmat([inducer [1e-5; 1e-5]],1,numPulses);                  % IPTG values for the input
    newExps.t_con{1}=union(0:100:duration, 30:100:duration);        % Switching times
