function [y0_all] = initialise_M1_Lugagne_experiments_pulse(global_theta_guess,inputs,epcc_exps)
...
exps.t_con{1}    = [0 48*60];                       % Input swithching times: Initial and final time
exps.t_f{1}      = 48*60;
...
ss.pathd.results_folder     = strcat('Initial_value_calculation',num2str(epcc_exps*rand(1,1)));         % Folder to keep results (in Results) for a given problem          
