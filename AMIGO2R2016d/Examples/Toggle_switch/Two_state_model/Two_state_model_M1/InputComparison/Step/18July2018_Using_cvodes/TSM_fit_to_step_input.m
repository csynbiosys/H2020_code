...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    model=two_state_model_log_transform;
    ...
    y0 = initialise_log_model(global_theta_guess,log([1;1e-5]),epcc_exps); % ensure that the inputs are non-zero
    ...
    % Save inducer levels after each run
    save([epccOutputResultFileNameBase,'exp_u','.mat'],'inducer');
