function [y0_all] = initialise_TSM(EXP_data,iexp)
...
exps.u{1}        = [ EXP_data{1,iexp}.IPTGext ; EXP_data{1,iexp}.aTcext];  %([EXP_data{1,iexp}.IPTGext+(1e-7.*(EXP_data{1,iexp}.IPTGext==0)); EXP_data{1,iexp}.aTcext+(1e-7.*(EXP_data{1,iexp}.aTcext==0))]);                                                   % Values of the input                                                % Values of the inputs
exps.n_exp       = 1;
...
ss.ivpsol.ivpsolver='cvodes'; %'cvodes';                     % [] IVP solver: 'radau5'(default, fortran)|'rkf45'|'lsodes'|
ss.ivpsol.senssolver='cvodes'; %'cvodes';                    % [] Sensitivities solver: 'cvodes' (C)
