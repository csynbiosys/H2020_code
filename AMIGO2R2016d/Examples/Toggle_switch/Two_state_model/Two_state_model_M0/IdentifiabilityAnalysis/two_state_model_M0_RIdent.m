...
%============================
inputs.pathd.results_folder='two_state_model'; % Folder to keep results (in Results) for a given problem                       
inputs.pathd.short_name='TSM_M0_RIdent';                       % To identify figures and reports for a given problem 
