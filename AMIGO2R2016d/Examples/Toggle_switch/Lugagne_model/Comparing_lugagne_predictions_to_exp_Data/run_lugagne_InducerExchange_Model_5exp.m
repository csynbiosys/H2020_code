...
inputs.model.exe_type='standard';
 ...
 for iexp= 1:inputs.exps.n_exp
     ...
     inputs.exps.exp_y0{iexp}=get_initial_values_for_simple_model(EXP_data,iexp);%[0,0,0.304420014782823,0.932964573854386,450.362572537976,855.546160287592]; %get_initial_values();       % Initial conditions for each experiment       
