function [y0_all] = gety0_InducerExchangeModel(EXP_data,iexp)
% This function calculates the state values for variables in the
% toggle switch model from an 80 hour simulation. It uses the inducer exchange model  
% described in Lugagne's paper. 

% Calculate Initial values of the variables in the model
y0_init_ss = EXP_data{1,iexp}.init[(1 3:6)]; %[0,0,0.304420014782823,0.932964573854386,450.362572537976,855.546160287592];
...
% load model
model= lugagne_toggle_switch_model_IEM(); %original_toggle_switch_model();
